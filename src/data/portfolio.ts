// ─── Structured data for visual components ───────────────────────────────
...
export const experienceData = [
  ...
  },
  {
    ...
    location: "Remote",
    highlights: [
      "Developed the frontend of a full-stack Stock Investment Platform, eliminating the need for 1+ brokerage apps by consolidating portfolio tracking, budgeting, learning modules, and dashboards using React.js (Hooks, React Router) and Tailwind CSS.",
      "Built the backend using Spring Boot (Maven) with NoSQL MongoDB and CORS for frontend integration with real-time stock data via Alpha Vantage API.",
    ],
  },
  {
...
export const projectsData = [
  {
    ...
    summary: "Built end-to-end deep learning pipeline by ingesting raw .wav files, parsing patient diagnosis.txt into a structured DataFrame, fine-tuning ResNet-18 (ImageNet) achieving 94.5% accuracy and 0.945 macro F1 across 5 respiratory disease classes. Resolved 49.5x class imbalance using cap-count augmentation lifting minority-class F1 to 0.91–0.96, validated generalization using 1,211 unseen samples by running full batch inference pipeline.",
    link: "https://github.com/AfrozeSVU/Multi-Class-Respiratory-Diagnostic-Model",
  },
  {
    name: "AgroNexus — National Hackathon Winner",
    period: "Oct 2024 — Nov 2024",
    stack: ["React", "Node.js", "Express", "MongoDB", "Gemini API"],
    summary: "Engineered AgroNexus using React.js, Node.js, Express.js, MongoDB to bridge farmer–consumer gaps, enabling direct markets, expert consultations, and multilingual support via Google Translate API, reducing communication delays from hours to seconds. Integrated Gemini, Geolocation, and Web Speech APIs, automated app insights by extracting ratings and reviews with Google Play Scraper and streamlining the entire workflow using Puppeteer — increased user engagement by 30%.",
    link: "https://github.com/AfrozeSVU/evoLUMIN",
  },
  {
    name: "Stock Investment Platform — Infosys Springboard",
    period: "Feb 2025 — Apr 2025",
    stack: ["React", "Spring Boot", "MongoDB", "Alpha Vantage API"],
    summary: "Developed the frontend of a full-stack Stock Investment Platform, eliminating the need for 1+ brokerage apps by consolidating portfolio tracking, budgeting, learning modules, and dashboards using React.js (Hooks, React Router) and Tailwind CSS. Built the backend using Spring Boot (Maven) with NoSQL MongoDB and CORS for frontend integration with real-time stock data via Alpha Vantage API.",
    link: "https://github.com/StockMarketInvestmentTeamB/FullStackProject",
  },
  {
    name: "PortfolioGen",
    period: "2024",
    stack: ["MERN", "Three.js", "Tailwind CSS", "GitHub API", "Vercel API", "Nodemailer", "AI"],
    summary: "Personalized Portfolio Creation using modern themes with user-friendly form inputs for professional details. Automated Deployment automates folder creation, GitHub repository creation, and deploys portfolios on Vercel. AI Integration and Nodemailer for delivering live-hosted links and repository URLs directly to users.",
    link: "https://github.com/AfrozeSVU/Portfolio-Generator",
  },
];
...
export const educationData = {
  ...
  scholarships: [
    { name: "Foundation for Excellence — Amazon Future Engineer Scholar", year: "2023" },
    { name: "AnitaB.org Scholar", year: "2025" },
    { name: "CodessCafe Mentee", year: "2024" },
  ],
  certifications: [
...
export const honorsData = [
  { emoji: "🏆", title: "AgroNexus — National Hackathon Winner", description: "Beat 500+ teams. Agri-tech platform bridging farmer–consumer gaps." },
  { emoji: "🎓", title: "Foundation for Excellence — Amazon Future Engineer Scholar", description: "Selected for academic merit and leadership in tech." },
  { emoji: "🌸", title: "AnitaB.org Scholar '25", description: "Recognized for contribution to women in computing." },
  { emoji: "☕", title: "CodessCafe Mentee", description: "Selected mentee in a curated program for women in software." },
  { emoji: "🎤", title: "TEDxSVU — Main Organizer", description: "Led organization and execution of the flagship campus TEDx event." },
  { emoji: "💻", title: "GirlScript Summer of Code 2024 (Extended)", description: "Active open-source contributor across multiple repositories." },
  { emoji: "📚", title: "CGPA 8.9 / 10 — Sri Venkateswara University", description: "Computer Science & Engineering." },
];
...
export const profile = {
  ...
  headline: "Machine Learning Engineer | Healthcare AI & Cloud Architect | Building Production-Grade AI Solutions.",
  email: "afroze@example.com", // EDIT ME
  socials: {
    linkedin: "https://www.linkedin.com/in/itsmeafroze/", // EDIT ME
    github: "https://github.com/AfrozeSVU",        // EDIT ME
    email: "afroze.mohammad25@gmail.com"  ,        // EDIT ME
    leetcode: "https://leetcode.com/u/Afroze_SVU/",           // EDIT ME
    Codeforces: "https://codeforces.com/profile/itsmeafroze",                 // EDIT ME
    resume: "https://drive.google.com/file/d/1rpp2WncbJXD5EcapEsQR5b6pJYYZXtnm/view?usp=sharing"
  },
};
...
timeline: List[Experience] = [
    ...
    Experience(
        ...
        location="Remote",
        highlights=[
            " Developedthefrontendofafull‑stack Stock Investment Platform, eliminating the need for 1+ brokerage apps byconsolidating
              portfolio tracking, budgeting, learning modules, and dashboards using React.js (Hooks, React Router) and Tailwind CSS",
             " Built thebackendusingSpringBoot(Maven)withNoSQLDatabaseMongoDBandCORSforfrontendintegrationwithreal‑time
               stock data via Alpha VantageAPI"
        ],
    ),
    Experience(
        company="GirlScript Summer of Code",
...
const projects = [
...

  {
    ...
    summary: \`Bridged farmer–consumer gaps with direct markets, expert consultations,
      and consultations, and access to digital tools — reducing communication delays from hours to seconds.
